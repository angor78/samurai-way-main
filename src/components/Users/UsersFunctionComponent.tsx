...
//
//
// export const UsersFunctionComponent = (props: UsersPropsType) => {
//
//   const getUsers = () => {
...
//                 <Image src={u.photos.small!=null?u.photos.small:'https://cdn-icons-png.flaticon.com/512/560/560216.png'} alt='avatar' boxSize='50px' objectFit='cover' display={'inline-block'}/>
